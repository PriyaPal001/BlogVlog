    ...
    <ul class="menu menu-horizontal px-1">
      {#each navs as nav}
        <li>
          <a
            href={nav.link}
            class:act={RouteID === nav.link}
            class="btn btn-ghost mx-2 hover:border-[#80ed99]">{nav.title}</a
          >
        </li>
      {/each}
    </ul>
...
<footer
  class="footer footer-center p-10 bg-base-200 text-base-content rounded mb-20 md:mb-0"
>
  ...
  <div>
    <div class="grid grid-flow-col gap-4">
      <a href="https://www.instagram.com/priyapal__.02/"
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
        ...
        ></a
      >
      <a href="https://www.linkedin.com/in/priya-bidyut-pal/"
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
