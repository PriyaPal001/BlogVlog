...
>
  ...
  <div class="relative flex items-start justify-between p-4 sm:p-6 lg:p-8">
    ...
    <div class="flex ">
      <a href={fufiData.insta_url} target="_blank" class="text-white mx-1 transition duration-100 hover:text-gray-900 active:text-gray-600">
      ...
      <a href={fufiData.linkedin_url} target="_blank" class="text-white mx-1 transition duration-100 hover:text-gray-900 active:text-gray-600">
        <svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
